...
class Registration extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('firstname, lastname, mobile, register_number', 'required'),
			array('mobile, register_number', 'numerical', 'integerOnly'=>true),
			array('firstname, lastname', 'length', 'max'=>30),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, firstname, lastname, mobile, register_number', 'safe', 'on'=>'search'),
		);
	}
