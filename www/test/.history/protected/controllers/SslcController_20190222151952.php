...
class SslcController extends Controller
{
	...
	public function actionTime()
	{
		if($_POST['id']==1)
		{
			...
			$this->renderPartial('dashboard',array('vendor'=>$vendor));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Sslc');
	...
	{
		$model=new Sslc('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Sslc']))
			$model->attributes=$_GET['Sslc'];
	 ...
	 * @return Sslc the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Sslc::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Sslc $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='sslc-form')
		{
